...
class Level extends Model
{
    ...
    public static function getUserCurrentLevel($user)
    {
    	...
    	$level['level1_user']     		= UserMaster::where('sponser_unique_id',$user_master['self_sponsor_key'])->count();
        ...
        if($level['level2_user'] >= $level2_user[0])
    	{
    		$level_text = 'LEVEL 2';
    	}
        ...
        if($level['level3_user'] >= $level3_user[0])
    	{
    		$level_text = 'LEVEL 3';
    	}
        ...
        if($level['level4_user'] >= $level4_user[0])
    	{
    		$level_text = 'LEVEL 4';
    	}
        ...
        if($level['level5_user'] >= $level5_user[0])
    	{
    		$level_text = 'LEVEL 5';
    	}
        ...
        if($level['level6_user'] >= $level6_user[0])
    	{
    		$level_text = 'LEVEL 6';
    	}
        ...
        if($level['level7_user'] >= $level7_user[0])
    	{
    		$level_text = 'LEVEL 7';
    	}
        ...
        if($level['level8_user'] >= $level8_user[0])
    	{
    		$level_text = 'LEVEL 8';
    	}
        ...
        if($level['level9_user'] >= $level9_user[0])
    	{
    		$level_text = 'LEVEL 9';
    	}
        ...
        if($level['level10_user'] >= $level10_user[0])
    	{
    		$level_text = 'LEVEL 10';
    	}
