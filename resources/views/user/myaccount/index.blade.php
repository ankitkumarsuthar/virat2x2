...
<script type="text/javascript">
    ...
    var form1 = $('#save_bank_detail');
    var error1 = $('.alert-danger', form1);
    $("#save_bank_detail").validate({
        errorElement: 'span', //default input error message container
        errorClass: 'help-block help-block-error', // default input error message class
        invalidHandler: function(event, validator) { //display error alert on form submit
            error1.show();
        ...
        messages: {                        
            bank_beneficiary_name : {
                required : 'Bank benificiary is a required filed.'
            },
            account_mumber : {
                required : 'Account number is a required filed.'
            },
            ifsc_code : {
                required : 'IFSC code is required field.'
            }
        }
    });


     var form3 = $('#save_paytm_detail');
    var error1 = $('.alert-danger', form3);
    $("#save_paytm_detail").validate({
        errorElement: 'span', //default input error message container
        errorClass: 'help-block help-block-error', // default input error message class
        invalidHandler: function(event, validator) { //display error alert on form submit
            error1.show();
        ...
        messages: {                        
            paytm_phone : {
                required : 'PAYTM field is a required field.'
            }
        }
    });


     var form2 = $('#save_upi_detai_form');
    var error1 = $('.alert-danger', form2);
    $("#save_upi_detai_form").validate({
        errorElement: 'span', //default input error message container
        errorClass: 'help-block help-block-error', // default input error message class
        invalidHandler: function(event, validator) { //display error alert on form submit
            error1.show();
        ...
        messages: {                        
            upi_id : {
                required : 'UPI id field is a required field.'
            }
        }
    });
