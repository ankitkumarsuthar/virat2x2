        ...
        <div class="col-md-8 col-lg-6 col-xl-5">
            <div class="card bg-pattern">
                ...
                <div class="card-body p-4">
                    ...
                    @include("user.login.partials.form")
            ...
            <div class="row mt-3">
                <div class="col-12 text-center">
                    <p> <a href="{{ URL::route('user.forgot.password') }}" class="text-white-50 ml-1">Forgot your password?</a></p>
                    <p class="text-white-50">Don't have an account? <a href="{{ URL::route('user.registration') }}" class="text-white ml-1"><b>Sign Up</b></a></p>
                </div> <!-- end col -->
            </div>
            <!-- end row -->
