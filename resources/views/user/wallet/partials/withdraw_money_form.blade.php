<div class="row">
    <div class="col-xl-6">
        <div class="card-box">
            ...
            <h4>&nbsp;</h4>
            {{ Form::open(['route' => ['user.wallet.withdraw.request'], 'class' => '', 'name' => 'withdraw_money', 'id' => 'withdraw_money' ]) }}
                <div class="form-group row">
                    <label for="inputEmail3" class="col-4 col-form-label">Current Wallet Amount<span class="text-danger">*</span></label>
                    <div class="col-7">
                        <label for="inputEmail3" class="col-4 col-form-label">{{ $current_balance }} INR<span class="text-danger"> </span></label>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="withdraw_option" class="col-4 col-form-label">Mobile No.<span class="text-danger">*</span></label>
                    <div class="col-7">
                        <select id="withdraw_option" name="withdraw_option" class="form-control" >
                ...
                <div class="form-group row">
                    ...
                    <div class="col-7">
                        <input type="text" class="form-control allowdecimalonly" max="{{ $current_balance }}"  name="withdraw_amount" id="withdraw_amount" placeholder="Transfer Amount">
                    </div>
                </div>
                <div class="form-group row">
