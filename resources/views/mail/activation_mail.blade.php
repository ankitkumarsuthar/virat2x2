                    ...
                    <table width="100%" cellpadding="0" cellspacing="0"
                        ...
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            <td class="content-block"
                                ...
                                valign="top">
                                Welcome to Vwaearn.com : {{ $params['name'] }}
                                <br>
                                <p>Hello</p><p>Your account is activated successfully.</p><p>Please login with your account registered email and password.</p><p>In case of password lost you can reset the password form the application.</p>
                            </td>
                        </tr>
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            <td class="content-block"
                                ...
                                Your Sponser Key: <b> {{ $params['self_sponsor_key'] }} </b> <br>
                            </td>
                        </tr>
