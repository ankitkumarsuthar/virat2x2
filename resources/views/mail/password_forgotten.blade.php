                    ...
                    <table width="100%" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            <td style="text-align: center">
                                <a href="{{ URL::route('admin.dashboard') }}" style="display: block;margin-bottom: 10px;"> <img src="{{ asset('public/assets/images/logo-dark.png') }}" height="24" alt="logo"/></a> <br/>
                            </td>
                        </tr>
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            <td class="content-block"
                                ...
                                valign="top">
                                Please click to below button to reset your account password.
                            </td>
                        </tr>
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            <td class="content-block"
                                style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                valign="top">
                                After click you will be redirected to the page where you can reset your password and access your account.
                            </td>
                        </tr>
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
