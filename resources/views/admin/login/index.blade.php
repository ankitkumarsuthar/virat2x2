@extends('admin.admin-auth')


@section('admmin-page-level-css')
                    ...
                    <div class="card bg-pattern">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center w-75 m-auto">
                                <div class="auth-logo">
                                    <a href="{{ URL::route('admin.login') }}" class="logo logo-dark text-center">
                                        <span class="logo-lg">
                                            <img src="{{ asset('public/assets/images/logo-dark.png') }}" alt="" height="70">
                                        </span>
                                    </a>
                
                                    <a href="{{ URL::route('admin.login') }}" class="logo logo-light text-center">
                                        <span class="logo-lg">
